<template>
  <section id='foot_guide'>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="position:absolute;width:0;height:0">
      <defs>
        <symbol viewBox="0 0 1024 1024" id="home">
          <g fill="#666" fill-rule="evenodd" stroke-width="2">
        ...
        <symbol viewBox="0 0 1024 1024" id="homeActive">
          <g fill="#0095FF" fill-rule="evenodd" stroke-width="2">
            <path d="M1017.382 622.826l-452.050-499.634c-14.051-15.533-32.992-24.086-53.333-24.086-0.002 0 0 0 0 0-20.339 0-39.282 8.555-53.334 24.086l-452.050 499.634c-9.485 10.485-8.675 26.674 1.808 36.158 4.899 4.432 11.043 6.616 17.168 6.616 6.982 0 13.938-2.838 18.992-8.426l109.016-120.491v410.517c0 42.347 34.453 76.8 76.8 76.8h563.2c42.347 0 76.8-34.453 76.8-76.8v-410.517l109.018 120.493c9.485 10.483 25.674 11.296 36.158 1.808 10.483-9.485 11.293-25.675 1.806-36.158zM614.4 972.8h-204.8v-230.4c0-14.115 11.485-25.6 25.6-25.6h153.6c14.115 0 25.6 11.485 25.6 25.6v230.4zM819.2 947.2c0 14.115-11.485 25.6-25.6 25.6h-128v-230.4c0-42.349-34.451-76.8-76.8-76.8h-153.6c-42.347 0-76.8 34.451-76.8 76.8v230.4h-128c-14.115 0-25.6-11.485-25.6-25.6v-467.106l291.832-322.552c4.222-4.667 9.68-7.237 15.368-7.237s11.146 2.57 15.366 7.235l291.834 322.552v467.107z"></path>
          </g>
        </symbol>
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 38 38" id="order">
          ...
          <g fill="none" fill-rule="evenodd">
            ...
            <rect width="18" height="2" x="7" y="17" fill="#666" rx="1"></rect>
            <rect width="12" height="2" x="7" y="26" fill="#666" rx="1"></rect>
          </g>
        </symbol>
    ...
    <section @click="gotoAddress({path: '/home', query: {geohash}})" class="guide_item">
      ...
      <span :style="{color:($route.path.indexOf('home') !== -1? '#0095FF' : '#666')}">首页</span>
    </section>
    <!-- 订单 -->
    <section @click="gotoAddress('/order')" class="guide_item">
      ...
      <span :style="{color:($route.path.indexOf('order') !== -1? '#0095FF' : '#666')}">订单</span>
    </section>
    <!-- 我的 -->
    <section @click="gotoAddress('/mine')" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('mine') !== -1? '#profileActive' : '#profile'"></use>
      </svg>
      <span :style="{color:($route.path.indexOf('mine') !== -1? '#0095FF' : '#666')}">我的</span>
    </section>
  </section>
</template>
<script>
...
#foot_guide {
  ...
  height: 1.95rem;
  display: flex;
  box-shadow: 0 -0.1rem 0.05rem rgba(0, 0, 0, .1);
}
